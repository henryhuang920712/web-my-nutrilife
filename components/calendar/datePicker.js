...
export default function DatePicker({ fieldName, value, setFieldValue }) {
    ...
    return (
        <div className="relative mb-4">
            <input
                ...
                onFocus={() => { setIsDatePickerVisible(true); console.log(1); }}
                // onBlur={() => setIsDatePickerVisible(false)} // Optional: to hide the picker when input loses focus
